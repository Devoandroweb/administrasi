    ...
    <div class="modal-content" style="margin-top: 70px">
      <div class="modal-body">
        <div class="text-center" style="margin-top: -70px">
            ...
            <h5><b>M. Fathur Rossidin (2093402)</b></h5>
        </div>
        <hr>
        <table class="table w-100">
            <tr>
                <td class="font-weight-bold">Tempat Lahir</td>
                <td class="text-right">Malang</td>
            </tr>
            <tr>
                <td class="font-weight-bold">Tanggal Lahir</td>
                <td class="text-right">12 Januari 1995  </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="text-right">II IPA</td>
            </tr>
            <tr>
                <td class="font-weight-bold text-center" colspan="2">Alamat</td>
            </tr>
            <tr>
                <td class="text-center" colspan="2">Jl. Keramat Patuk Krajan Malang</td>
            </tr>
        </table>
      </div>
